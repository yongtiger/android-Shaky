...
import cc.brainbook.android.shaky.util.Falcon;
import cc.brainbook.android.shaky.util.ShakeDetector;
 ...
 * the {@link cc.brainbook.android.shaky.CollectDataTask} completes while there is no activity attached, the feedback
...
public class Shaky implements ShakeDetector.Listener {
    ...
    private Bitmap getScreenshotBitmap() {
        try {
            ...
            //////??????https://github.com/jraska/Falcon(kotlin)
